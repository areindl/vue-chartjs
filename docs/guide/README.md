...
Sometimes you need to override the default settings of Chart.js charts. For example to set a global default font here [here](https://www.chartjs.org/docs/latest/general/fonts.html).

To achieve this, you need to import Chart.js manually in your Vue componenent. There you can set defaults:
